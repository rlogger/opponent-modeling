...
```bash
uv run --locked --extra train --extra plot python scripts/render_environment.py --dataset experiments/shashank_comparison_20260908/continuous_data/dataset.npz --out experiments/shashank_comparison_20260908/environment
```
