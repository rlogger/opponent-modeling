...
```bash
uv run --locked --extra train --extra plot python scripts/visualize_0s.py --run experiments/shashank_comparison_20260908/continuous/seed_0 --dataset experiments/shashank_comparison_20260908/continuous_data/dataset.npz --out experiments/shashank_comparison_20260908/continuous/seed_0/visuals
uv run --locked --extra train --extra plot python scripts/visualize_0s_rollouts.py --run experiments/shashank_comparison_20260908/continuous/seed_0 --dataset experiments/shashank_comparison_20260908/continuous_data/dataset.npz --out experiments/shashank_comparison_20260908/continuous/seed_0/visuals
```
